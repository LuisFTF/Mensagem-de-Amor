...
function envelop_transition() {
  gsap.to(".js-up-paper", {
    bottom: "1%",
    duration: 0.1, // Mude de 0.25 para 0.1 para ser quase instantâneo
...
//-> Função que remove o selo e já prepara o envelope para abrir
function sticker() {
  gsap.set(".js-sticker", { display: "none" });
  envelop_transition(); // Isso faz o envelope abrir na hora que clicar no coração!
}

// Garante que o evento de clique esteja ativo
document.querySelector(".js-sticker").addEventListener("click", sticker);
document.querySelector(".js-sticker").addEventListener("touchstart", sticker); // Melhora no celular
